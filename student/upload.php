...
if(isset($_POST["submit"]) && empty($_FILES["file"]["name"])){
    ...
    if ($count > 0) {
        ...
        $insert = $db->query("INSERT INTO new_requests (student_id, instructor_id, note) VALUES ('$student_id',(SELECT id FROM instructors WHERE first_name = '$token' AND last_name = '$token2'),'$note')");
